import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{l as r,n as i,t as a,u as o}from"./themeProps-BLML-F6E.js";import{O as s,o as c,t as l}from"./utils-BesPgzBU.js";import{t as u}from"./jsx-runtime-DqZldVDK.js";import{n as d,t as f}from"./layerAnimations.stylex-CPfvluO1.js";import{_ as p,u as m}from"./tokens.stylex-CSS49WQe.js";import{n as h,t as g}from"./useIsomorphicLayoutEffect-AEBSTB0m.js";import{n as _,t as v}from"./usePopover-wP2lSWCI.js";import{n as y,t as b}from"./InteractiveRoleContext-DtotSF-S.js";function x(e){return e.matches(T)?e:e.querySelector(T)}function S({children:e,anchorRef:t,content:n,placement:r=`below`,alignment:a=`start`,isOpen:c,onOpenChange:l,isEnabled:u=!0,width:f,label:m,role:g=`dialog`,isModal:v,hasCloseButton:y,closeButtonLabel:S,hasAutoFocus:T,hasLightDismiss:D=!0,hasEscapeDismiss:O=!0,xstyle:k,className:A,style:j,"data-testid":M}){let N=(0,C.useRef)(null),P=c!==void 0,F=(0,C.useRef)(0),I=_({dialogLabel:m,role:g,isModal:v,hasLightDismiss:D,hasEscapeDismiss:O,hasCloseButton:y,closeButtonLabel:S,hasAutoFocus:T,onShow:(0,C.useCallback)(()=>{l?.(!0)},[l]),onHide:(0,C.useCallback)(()=>{F.current=Date.now(),l?.(!1)},[l])}),L=(0,C.useCallback)(()=>{u&&(Date.now()-F.current<50||I.toggle())},[u,I]),R=(0,C.useCallback)(e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),L())},[L]),z=(0,C.useCallback)(e=>{e.setAttribute(`aria-haspopup`,I.triggerProps[`aria-haspopup`]),e.setAttribute(`aria-expanded`,String(I.triggerProps[`aria-expanded`])),e.setAttribute(`aria-controls`,I.triggerProps[`aria-controls`]),e.addEventListener(`click`,L);let t=e.tagName!==`BUTTON`&&e.getAttribute(`role`)===`button`;return t&&e.addEventListener(`keydown`,R),()=>{e.removeAttribute(`aria-haspopup`),e.removeAttribute(`aria-expanded`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,L),t&&e.removeEventListener(`keydown`,R)}},[I,L,R]);h(()=>{if(!t)return;let e=t.current;if(!e)return;let n=x(e);if(!n)return;I.triggerRef(e);let r=z(n);return()=>{I.triggerRef(null),r()}},[t,I,z]),h(()=>{if(t||typeof e==`function`)return;let n=N.current;if(!n)return;I.triggerRef(n);let r=x(n);if(!r)return;let i=z(r);return()=>{I.triggerRef(null),i()}},[t,I,z]),h(()=>{P&&(c&&!I.isOpen?I.show():!c&&I.isOpen&&I.hide())},[c,P,I]);let B=f?E.customWidth(f):E.matchTrigger;return t&&e==null?(0,w.jsx)(w.Fragment,{children:I.render((0,w.jsx)(`div`,{"data-testid":M,...s(i(`popover`),o(E.contentPadding,k),A,j),children:n}),{placement:r,alignment:a,offset:p[`--spacing-1`],xstyle:[B,d[r]]})}):typeof e==`function`?(0,w.jsxs)(w.Fragment,{children:[e({ref:I.triggerRef,onClick:L,"aria-haspopup":`dialog`,"aria-expanded":I.isOpen,"aria-controls":I.id}),I.render((0,w.jsx)(`div`,{"data-testid":M,...s(i(`popover`),o(E.contentPadding,k),A,j),children:n}),{placement:r,alignment:a,offset:p[`--spacing-1`],xstyle:[B,d[r]]})]}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(b,{value:`button`,children:(0,w.jsx)(`div`,{ref:N,className:`astryx3nfvp2`,children:e})}),I.render((0,w.jsx)(`div`,{"data-testid":M,...s(i(`popover`),o(E.contentPadding,k),A,j),children:n}),{placement:r,alignment:a,offset:p[`--spacing-1`],xstyle:[B,d[r]]})]})}var C,w,T,E,D=e((()=>{C=t(n(),1),g(),r(),l(),c(),v(),f(),m(),y(),a(),w=u(),T=`button, [role="button"]`,E={contentPadding:{kLKAdn:`astryx1vlblms`,kGO01o:`astryxvmdzux`,kZCmMZ:`astryx126nfab`,kwRFfy:`astryx1t818jl`,$$css:!0},customWidth:e=>[{kzqmXN:(typeof e==`number`?`${e}px`:e)==null?typeof e==`number`?`${e}px`:e:`astryx5lhr3w`,$$css:!0},{"--x-width":(e=>typeof e==`number`?e+`px`:e??void 0)(typeof e==`number`?`${e}px`:e)}],matchTrigger:{k7Eaqz:`astryxrzjruh`,$$css:!0}},S.displayName=`Popover`,S.__docgenInfo={description:`A click-triggered popover for displaying interactive content anchored to a trigger.
