import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{l as ee,n as r,t as i,u as te}from"./themeProps-_oSbOSxB.js";import{E as ne,G as a,O as re,Q as ie,_t as o,m as ae,ot as oe,t as s,tt as c}from"./utils-CJ7epcQk.js";import{t as l}from"./jsx-runtime-DqZldVDK.js";import{n as se}from"./useTooltip-q7njLCs1.js";import{n as ce,t as u}from"./Spinner-dCfVnCjm.js";import{n as d,t as f}from"./VisuallyHidden-DDrJpIxj.js";import{n as p,r as le}from"./SizeContext-fcGnTOs5.js";import{r as ue,t as m}from"./i18n-CWrnVPIh.js";import{i as h,t as g}from"./Icon-7nTCyQ1B.js";import{n as de}from"./usePopover-BZbM7W-r.js";import{t as _}from"./Tooltip-BnbJ3j7w.js";import{a as fe,i as pe}from"./hooks-B-jBP9yR.js";import{t as me}from"./Popover-CYYDTP2A.js";import{i as v,n as he,o as ge,t as y}from"./Calendar-BM1UkSWG.js";import{t as _e}from"./Field-stqwPAkS.js";import{a as ve,c as b,o as ye,s as be,t as x}from"./Field-j37oN_5s.js";import{a as S,i as xe,n as C,r as Se}from"./InputGroupContext-DfUisVOG.js";function w({label:e,isLabelHidden:t=!1,description:n,isOptional:ee=!1,isRequired:i=!1,isDisabled:s=!1,disabledMessage:c,value:l,onChange:u,changeAction:f,isLoading:p=!1,min:m,max:g,dateConstraints:_,placeholder:pe,size:me,status:v,statusVariant:y=`attached`,labelTooltip:x,hasClear:S=!1,numberOfMonths:C=1,weekStartsOn:w,format:O=`date_long`,width:k,xstyle:Ce,className:we,style:Te,ref:Ee,...De}){let A=ue(),Oe=pe??A(`@astryx.dateInput.placeholder`),j=le(me,`md`),M=(0,T.useId)(),N=(0,T.useId)(),P=(0,T.useId)(),F=(0,T.useId)(),I=(0,T.useRef)(null),L=(0,T.useRef)(null),R=(0,T.useRef)(void 0),z=Se(),[,B]=(0,T.useTransition)(),[V,H]=(0,T.useOptimistic)(l),U=p||V!==l,W=s||U,G=s&&!!c,K=se({placement:`above`,focusTrigger:`always`,isEnabled:G}),{isDateDisabled:q}=ge({min:m,max:g,dateConstraints:_}),{statusIcon:ke,describedBy:Ae}=fe({status:v,statusVariant:y,isInGroup:!!z}),{ariaLabelledBy:je,ariaDescribedBy:Me}=ae(N,[n?P:null,y!==`tooltip`&&v?.message?F:null,Ae,G?K.describedBy:null],z),[J,Y]=(0,T.useState)(null),Ne=(0,T.useRef)(l);l!==Ne.current&&(Ne.current=l,l!==R.current&&(R.current=void 0,J!==null&&Y(null)));let Pe=(0,T.useCallback)(e=>typeof O==`function`?O(e):ie(oe(e),O),[O]),Fe=J===null?V&&/^\d{4}-\d{2}-\d{2}$/.test(V)?Pe(V):``:J,X=J===null||!J.trim()?!0:a(J)!==null,Z=de({dialogLabel:A(`@astryx.dateInput.dialogLabel`),closeButtonLabel:A(`@astryx.dateInput.closeCalendar`),onHide:()=>I.current?.focus()}),Ie=(0,T.useCallback)(()=>{W||(Z.isOpen?Z.hide():Z.show())},[W,Z]),Le=(0,T.useCallback)(()=>{!W&&!Z.isOpen&&Z.show({skipAutoFocus:!0})},[W,Z]),Q=(0,T.useCallback)(e=>{U||(u?.(e),f&&B(async()=>{H(e),await f(e)}))},[U,u,f,B,H]),Re=(0,T.useCallback)(()=>{Q(void 0),I.current?.focus()},[Q]),ze=(0,T.useCallback)(e=>{Q(e),Y(null),Z.hide()},[Q,Z]),Be=(0,T.useCallback)(e=>{if(W)return;let t=e.target.value;Y(t);let n=a(t);if(n&&o(n)!==l&&!q(n)){let e=o(n);R.current=e,Q(e),L.current?.navigateTo(e)}},[l,Q,q,W]),$=(0,T.useCallback)(()=>{if(J===null)return;if(!J.trim()){l!==void 0&&Q(void 0),Y(null);return}let e=a(J);if(e&&!q(e)){let t=o(e);t!==l&&Q(t)}Y(null)},[J,l,Q,q]),Ve=(0,T.useCallback)(()=>{$()},[$]),He=(0,T.useCallback)(e=>{e.key===`Escape`&&Z.isOpen?(e.preventDefault(),Z.hide()):(e.key===`ArrowDown`||e.altKey&&e.key===`ArrowDown`)&&!Z.isOpen?(e.preventDefault(),W||Z.show({skipAutoFocus:!0})):e.key===`Enter`&&(e.preventDefault(),$())},[Z,$,W]),Ue=(0,E.jsxs)(`div`,{ref:e=>{Z.triggerRef(e),K.ref(e)},...De,...re(r(`date-input`,{size:j,status:v?.type??null,disabled:s?`disabled`:null}),te(b.base,D[j],W&&b.disabled,v&&ve[v.type],v&&!W&&be[v.type],v&&ye[v.type],z&&xe.inGroup,Ce),we,Te),children:[z&&(0,E.jsx)(d,{id:N,children:e}),(0,E.jsx)(`button`,{type:`button`,onClick:Ie,disabled:W,"aria-label":Z.isOpen?A(`@astryx.dateInput.toggleCalendarClose`):A(`@astryx.dateInput.openCalendar`),...{0:{className:`astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto`},1:{className:`astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto astryx1h6gzvc`}}[!!W<<0],children:(0,E.jsx)(h,{icon:`calendar`,size:`sm`,color:`secondary`,...r(`date-input-toggle-icon`,{state:Z.isOpen?`expanded`:`collapsed`})})}),(0,E.jsx)(`input`,{ref:ne(Ee,I),id:M,type:`text`,role:`combobox`,value:Fe,onChange:Be,onBlur:Ve,onClick:Le,onKeyDown:He,placeholder:Oe,disabled:W&&!G,"aria-disabled":G?`true`:void 0,readOnly:G||void 0,"aria-labelledby":je,"aria-describedby":Me,"aria-required":i===!0?`true`:void 0,"aria-invalid":v?.type===`error`||!X?`true`:void 0,"aria-busy":U||void 0,"aria-expanded":Z.isOpen,"aria-haspopup":`dialog`,"aria-controls":Z.isOpen?Z.id:void 0,"aria-autocomplete":`none`,autoComplete:`off`,...{0:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5`},2:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc`},1:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4`},3:{className:`astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4`}}[!!W<<1|!X<<0]}),(0,E.jsx)(d,{as:`div`,role:`alert`,"aria-live":`assertive`,children:X?``:`Invalid date`}),S&&l!==void 0&&!W&&(0,E.jsx)(`button`,{type:`button`,onClick:Re,"aria-label":A(`@astryx.dateInput.clear`,{label:e}),className:`astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto`,children:(0,E.jsx)(h,{icon:`close`,size:`sm`,color:`secondary`,...r(`date-input-clear-icon`)})}),U&&(0,E.jsx)(ce,{size:`sm`}),ke,Z.render((0,E.jsx)(he,{handleRef:L,mode:`single`,value:V,onChange:ze,min:m,max:g,dateConstraints:_,numberOfMonths:C,weekStartsOn:w}),{placement:`below`,alignment:`start`}),G&&K.renderTooltip(c)]});return z?Ue:(0,E.jsx)(_e,{label:e,isLabelHidden:t,description:n,inputID:M,descriptionID:n?P:void 0,isOptional:ee,isRequired:i,isDisabled:s,status:v?{type:v.type,message:v.message,messageID:v.message?F:void 0}:void 0,statusVariant:y,labelTooltip:x,width:k,children:Ue})}var T,E,D,O=e((()=>{T=t(n(),1),ee(),x(),g(),f(),C(),S(),p(),u(),y(),v(),pe(),me(),_(),s(),c(),E=l(),i(),m(),D={sm:{kZKoxP:`astryx6k0iem`,k7Eaqz:`astryxfb3i0g`,$$css:!0},md:{kZKoxP:`astryx1ueg155`,k7Eaqz:`astryxfb3i0g`,$$css:!0},lg:{kZKoxP:`astryxssyfek`,k7Eaqz:`astryxfb3i0g`,$$css:!0}},w.displayName=`DateInput`,w.__docgenInfo={description:`A date picker component combining a text input with a calendar popover.
