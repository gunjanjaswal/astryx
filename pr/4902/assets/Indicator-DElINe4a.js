...
change action is pending.`}},composes:[`Omit`]}}));function b({state:e,size:t=`md`,isDisabled:n=!1,children:a,ref:o,className:s,style:c,xstyle:l,...u}){return a==null?e===`checked`?(0,x.jsx)(f,{...u,icon:`check`,size:S[t],color:n?`disabled`:`accent`,xstyle:l,className:s,style:c}):null:(0,x.jsx)(`span`,{...u,ref:o,"aria-hidden":`true`,...i(r(l),s,c),children:a})}var x,S,C=e((()=>{t(),d(),a(),x=o(),S={sm:`sm`,md:`sm`},b.displayName=`CheckIndicator`,b.__docgenInfo={description:`The default single-selection mark: a checkmark when chosen, nothing when not.
