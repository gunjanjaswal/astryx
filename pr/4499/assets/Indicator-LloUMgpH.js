...
change action is pending.`}},composes:[`Omit`]}}));function x({state:e,size:i=`md`,isDisabled:a=!1,children:o,ref:s,className:c,style:l,xstyle:u,...d}){let f=e===`checked`;return r(o)?(0,S.jsx)(`span`,{...d,ref:s,"aria-hidden":`true`,...t(n(w.slot,a?w.disabled:w.enabled,u),c,l),children:o}):f?(0,S.jsx)(p,{...d,"aria-hidden":`true`,icon:`check`,size:C[i],color:a?`disabled`:`accent`,xstyle:u,className:c,style:l}):null}var S,C,w,T=e((()=>{o(),f(),i(),S=s(),C={sm:`sm`,md:`sm`},w={slot:{k1xSpc:`astryx3nfvp2`,kGNEyG:`astryx6s0dn4`,kjj79g:`astryxl56j7k`,kmuXW:`astryx2lah0s`,kzqmXN:`astryxcdlrvm`,kZKoxP:`astryx1l36t39`,$$css:!0},enabled:{kMwMTN:`astryxqwr325`,$$css:!0},disabled:{kMwMTN:`astryxqa6c3m`,$$css:!0}},x.displayName=`CheckIndicator`,x.__docgenInfo={description:`The default single-selection mark: a checkmark when chosen, nothing when not.
